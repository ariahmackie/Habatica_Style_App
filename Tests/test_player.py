...
from Model.player import Account
from Model.player import Backpack
from Model.player import Task
import datetime
...
class TestPlayer(unittest.TestCase):
    ...
    def test_init(self):
        ...
        username = "Bob"
        password = 123
        hero = Player(email, username, password)
    ...
    def test_add_to_tasklist(self):
        ...
        self.assertEqual(hero.tasklist[0].description, "do homework", "task added")
...
class TestAccount(unittest.TestCase):
    ...
    def test_init_account(self):
        newaccount = Account("bob@gmail.com", "Bob", 123)
...
class TestBackpack(unittest.TestCase):
    ...
    def test_get_backpack_items(self):
        backpack = Backpack()
        self.assertEqual(backpack.get_backpack_items() ,{}, "should return dictionary")

    def test_add_items(self):
        backpack = Backpack()
        backpack.add_items("ruby", 10)
        self.assertEqual(backpack.get_backpack_items(), {"ruby": 10}, "ten rubies expected in backpack")
...
class TestTask(unittest.TestCase):
    ...
    def test_make_task_repeatable(self):
        newtask = Task("make your bed")
        self.assertFalse(newtask.is_repeatable, "not repeatable before made repeatable" )
        newtask.make_task_repeatible()
        self.assertTrue(newtask.is_repeatable, "tasks should be repeatable now")
